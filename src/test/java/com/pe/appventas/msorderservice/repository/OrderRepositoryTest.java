package com.pe.appventas.msorderservice.repository;
...
import com.pe.appventas.msorderservice.util.RepositoryDataUtils;
...
public class OrderRepositoryTest {
    ...
    public void shouldSaveOrderWhenSaveIsCalled() {
        ...
        Assertions.assertNotNull(foundOrder.getTotalIgv());
        Assertions.assertNotNull(foundOrder.getTotalAmountIgv());
    ...
    public void shouldReturnAllOrdersByAccountIdWhenFindByAccountIdIsCalled() {
        List<Order> orders = orderRepository.findOrderByAccountId("9876512");
